...
11. **Graph Data** — **X col** / **Y col** pull-downs (`XCol`, `YCol` combo, items from `ColHeaders_RBV`); **Norm** (`NormMode`, `NormCol`, `NormValue`) SPiCE-style divide-by-column or fixed value; **Columns** line lists all names
